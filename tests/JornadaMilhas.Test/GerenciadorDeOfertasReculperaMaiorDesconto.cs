...
{
    public class GerenciadorDeOfertasReculperaMaiorDesconto
    {
        [Fact]
        public void RetornaOfertaNulaQuandoListaEstaVazia()
        {
            ...
            var oferta = gerenciador.ReculperaMaiorDesconto(filtro);

            Assert.Null(oferta);
        }

        [Fact]
        public void RetornaOfertaEspecificaQuandoDestinoSaoPauloEDescondo40()
        {
